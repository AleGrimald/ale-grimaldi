...
const Main=(props)=>{
    const {titulo, p1, p2, clases, arrLi, imagenes, estilosFlecha} = props.datosMain;
    ...
    return <main className='main'>
        <div className='main_texto'>
            ...
            <Ul clase={clase_link} claseFlecha={clase_flecha} datos={arrLi} imagen={flecha.icono} estilos={estilosFlecha}/>
        </div>
